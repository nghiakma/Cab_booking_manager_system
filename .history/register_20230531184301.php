...
<body class="">
  ...
  <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['image_file'])) {
    $target_dir = "uploads/"; // This is the directory where the uploaded file will be stored.
    ...
    if (file_exists($target_file)) {
      ...
      if (move_uploaded_file($_FILES["image_file"]["tmp_name"], $target_file)) {
        ...
        echo validate_image($target_file);
      } else {
          ...
          <form id="register-frm" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-12 text-center">
                <a href="<?php echo base_url . 'login.php' ?>" style="text-decoration:none;">Already
                  have
                  an Account</a>
              </div>
            </div>
